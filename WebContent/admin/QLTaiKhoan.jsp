...
<html>
<head>
<title>Tài Khoản | Trang Admin</title>
...
<div id="wrapper">
	...
	<a href = "addTaiKhoan">Thêm tài khoản</a>
		<table class="data">
			...
			<center>
				<a href="Update_TaiKhoa	n?command=update&ID=<%=tk.getID()%>">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
		...
		<label>Ghi Chú: Quyền quản lý Admin:0; User:1</label>
	</div>
<!-- footer -->
