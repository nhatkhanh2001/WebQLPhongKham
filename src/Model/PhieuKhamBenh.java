...
public class PhieuKhamBenh {
	...
	public PhieuKhamBenh(int iD, String maPhieu, String tinhTrangBN, String diUngThuoc, String khamLamSang, String benhKemTheo, String nhipTim, String nhipTho, String huyetAp, String nhietDo, String canNang, String chieuCao, String chanDoan, Float tienKham, Date ngayKham) {
		ID = iD;
		MaPhieu = maPhieu;
