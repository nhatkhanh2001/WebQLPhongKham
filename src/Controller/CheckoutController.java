...
public class CheckoutController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			 ...
			 * ChiTietDonHangDAO.insertChiTietDonHang (new
			 * ChiTietDonHang("DH"+idhd,list.getKey(),list.getValue().getSanpham().getGia(),
			 * list.getValue().getSoLuong(),new Timestamp(new
			 * Date(millis).getTime()),payment); }
			 */
			cart = new Cart();
